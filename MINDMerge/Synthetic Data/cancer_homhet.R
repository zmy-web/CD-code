...
for(dataNO in 1:10){
  print(dataNO)
  filepath = paste('select/cancer_1000_',dataNO,'.csv',sep='')
  ...
  for(method in 1:5){
    ...
    filepath2 = paste('./result/',dataNO,'_cancer_ad_1000_result_',sep='')
    filepath1 = paste(filepath2,method,'.csv',sep='')
    write.csv(matrix_sum_one,filepath1,row.names = TRUE,col.names =TRUE,sep='')
    filepath2 = paste('./result/',dataNO,'_cancer_ad_1000_efbn_',sep='')
    filepath1 = paste(filepath2,method,'.csv',sep='')
