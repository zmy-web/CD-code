...
alarm = 'alarm_200_2000'

for threshold in np.arange(0.25, 2, 0.15):
    dict1 = {}
    ...
    for dataNo in range(1,11):
        ...
        total_result[total_result < threshold] = 0
    ...
    with open(f'C:\\Users\\riyang\\Documents\\BNdata\\{alarm}_{threshold}_file.json', 'w', encoding='utf-8')as file: 
