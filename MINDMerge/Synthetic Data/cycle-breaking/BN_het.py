...
for dataNo in range(1,11):
        ...
        tmp = pd.read_csv(f'C:\\Users\\riyang\\Documents\\BNdata\\result\\{dataNo}_{alarm}_al_efbn_3.csv', index_col=0)
    ...
    #
with open(f'C:\\Users\\riyang\\Documents\BNdata\\{dataNo}_{alarm}_score_al_file.json', 'w', encoding='utf-8')as file:  
