...
for dataNo in range(1,6):
    for NO in range(1,6):
        tmp = pd.read_csv(f'C:\\Users\\riyang\\Documents\\local\\result\\{dataNo}_{alarm}_efbn_{dataNo}.csv', index_col=0)
        ...
        W_est = notears_linear(X, lambda1=0.1, lambda2=5, loss_type='l2')
    ...
    #
    with open(f'C:\\Users\\riyang\\Documents\local\\{dataNo}_{hospitalID}_hom_file.json', 'w', encoding='utf-8')as file:  
